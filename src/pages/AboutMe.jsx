...
const AboutMe = () => (
  <div className="about-me-container">
    <section className="about-me">
      ...
      <p>
        Hi, I'm Finian Corbett, a dedicated and passionate web developer with a strong focus on creating dynamic, responsive, and user-friendly web applications. With several years of experience in the industry, I have honed my skills in HTML, CSS, JavaScript, and various modern frameworks like React, allowing me to deliver high-quality and efficient solutions.
      </p>
      <p>
